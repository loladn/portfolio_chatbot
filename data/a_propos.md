...
- Apprentissage continu et découverte permanente
- Sortir de sa zone de confort au quotidien
- Explorer de nouveaux domaines
- Acquérir de nouvelles compétences

## Engagements associatifs et culturels

### Bénévolat dans les festivals
- **Festival Superflux** (Tours) : Communication, création de contenu
- **Festival Terres du Son** (Tours) : Travail en équipe dans un bar

### Communication et réseaux sociaux
**Community manager** des réseaux sociaux du BUT Science des données de Niort avec 3 autres étudiants.

### Hobbies artistiques
- **Photographie** : Redécouverte de Tours et de son environnement
- **Musique** : Concerts, découverte d'artistes

## Centres d'intérêt techniques

### Passion pour la géomatique
Intérêt marqué pour les **Systèmes d'Information Géographiques (SIG)** et l'analyse spatiale.

### Domaines d'expertise en data
...
- Rigueur et compétences techniques au quotidien
- Point de vue différent, plus logique et méthodique
- Meilleure compréhension des cas pratiques

## Projet professionnel après le BUT
...
**Email** : lola.dixneuf@etu.univ-poitiers.fr

**LinkedIn** : Lola Dixneuf - https://www.linkedin.com/in/lola-dixneuf-701a57298

Ouverte aux échanges sur :
- Projets data science et géomatique
